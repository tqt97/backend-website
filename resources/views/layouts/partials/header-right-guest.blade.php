<div class="flex space-x-4">
    ...
    <a wire:navigate="" class="py-1 px-2 transition duration-200 ease-in-out border rounded-md bg-gray-900 dark:bg-white text-white dark:text-gray-900" href="http://127.0.0.1:8000/register">
        {{ __('frontend/nav.register') }}
    </a>
    {{-- <x-nav-custom.li href="{{ route('login') }}" :active="request()->routeIs('login')">
        <x-icons.user/>
