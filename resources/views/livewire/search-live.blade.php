<div class="relative">
    <div class="relative">
        ...
        <input wire:model.live.debounce.250ms="q" id="search" name="search" x-ref="inputSearch"
            ...
            rounded-lg focus:border-gray-400 focus:outline-none focus:ring focus:ring-gray-400 focus:ring-opacity-40
            ...
            <div class="text-sm text-gray-800">
                ...
                @forelse($results as $result)
                    <a href="{{ route('posts.show', ['post' => $result]) }}"
                        class="flex items-center text-gray-800 px-4 py-2 transition-all border-b
                        hover:bg-gray-50 hover:text-gray-900 cursor-pointer duration-250">
                        <span>
